...
// this function updates the screen within the contents of Display_Value
...
keys.addEventListener('click', (event) => {
    // the target variable is an obkect that represents the element
    // that was clicked
    const { target } = event;
    // if the element that was clickedd on is not a button, exit the function
